defmodule Benchee do
  ...
  @doc """
  Run bench jobs defined by a map and optionally provide configuration
  options.

  Runs the given benchmarks and prints the results on the console.

  * jobs - a map from descriptive bench job name to a function to be
  ...
  * config - configuration options to alter what Benchee does, see
  ...
  ## Examples
      ...
      # Prints a summary of the bench to the console
  ...
  @doc """
  Convenience access to `Benchee.Benchmark.bench/3` to define the benchmarks
