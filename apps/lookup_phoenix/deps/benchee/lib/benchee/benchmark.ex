defmodule Benchee.Benchmark do
  ...
  There will be `parallel` processes spawned exeuting the bench job in
  parallel.
  """
  ...
  @fast_warning """
  Warning: The function you are trying to bench is super fast, making measures more unreliable! See: https://github.com/PragTob/benchee/wiki/Benchee-Warnings#fast-execution-warning
  """
